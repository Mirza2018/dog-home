        ...
        <div className='container mx-auto pt-5'>
            ...
            <div className='flex gap-8 flex-row-reverse'>
                ...
                <div className='flex-1 flex flex-col justify-center items-center '>
                    ...
                    <h1 className='text-4xl font-bold mb-7  '>Create an account</h1>
                    ...
                    <form action="" className="w-full max-w-sm">
                        ...
                        <h1 className='text-gray-500'>Already have an account?<button className="btn btn-link no-underline text-[#F88D58] font-thin  my-2">Log in</button></h1>
                    {/* <GoogleLogin/> */}
                </div>
            </div>
        </div>
